  ...
  return (
    <div className="contact-container">
      <div className="contact-info">
        <h2>CONTACT US</h2>
        <p><strong>Address:</strong> C7 Modern Complex near Motibag Chowk, Ghaziabad C.G. 201001</p>
        <p><strong>Phone:</strong> <a href="tel:+918871132000">+91 88711 02520</a></p>
        <p><strong>Email:</strong> <a href="mailto:hello@ssguds.com">hello@ssguds.com</a></p>
      </div>
